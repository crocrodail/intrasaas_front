...
export default function CardTableProjectsTeacher({ color, data }) {
                ...
                <tr key={index}>
                  ...
                  <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 text-right">
                    <button
                      ...
                      onClick={() =>
                        router.push({
                          pathname: `/teacher/projects/${item._id}`,
                          query: {
                            id: `${item.idModule}`,
                          },
                        })
...
CardTableProjectsTeacher.defaultProps = {
  color: "light",
};

CardTableProjectsTeacher.propTypes = {
