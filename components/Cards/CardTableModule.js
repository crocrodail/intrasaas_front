...
export default function CardTableModule({ color, data }) {
      ...
      >
        ...
        <div className="block w-full overflow-x-auto">
          ...
          <table className="items-center w-full bg-transparent border-collapse">
            ...
            <tbody>
              {modules.project.map((item, index) => (
                <tr key={index}>
            ...
            <tbody>
              {modules.lessons.map((item, index) => (
                <tr key={index}>
                  ...
                  <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                    {DateTime.fromISO(
                      data.lessons[0].StartTime
                    ).toLocaleString()}
                  </td>
                  <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                    {DateTime.fromISO(data.lessons[0].EndTime).toLocaleString()}
                  </td>
...
CardTableModule.defaultProps = {
  color: "light",
};

CardTableModule.propTypes = {
